...
GENERATOR_FLAGS="--training_mode=pgd --class_cond=False --decoder_style=unet --loss_norm=cnn_vit --num_res_blocks_high=2 --num_res_blocks=3 --resblock_updown=True"
...
$CKPT_FLAGS \
--out_dir out/sampling/30-7-ffhq_128 \
--model_path /home/bratosiewicz/pagoda/out/29-7_pgd_stage3_128_try2/decoder_ema_0.9999_160000.pt \
