...
STAGE_1_FLAGS="--num_channels=192 --num_channels_high=192 --num_head_channels=64 --num_res_blocks=3 --num_res_blocks_high=2 --diffusion_weight_schedule=karras_weight --diffusion_schedule_sampler=lognormal --ema_rate=0.9999"
